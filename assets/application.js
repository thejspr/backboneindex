...
(function() {
  ...
  this.BackboneIndex.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    Entities.Category = (function(superClass) {
    ...
    return Entities.CategoryList = (function(superClass) {
  ...
  this.BackboneIndex.module("Views", function(Views, App, Backbone, Marionette, $, _) {
    Views.CategoryView = (function(superClass) {
      ...
      CategoryView.prototype.el = "#categories";

      CategoryView.prototype.template = _.template("<label class='checkbox'><input class='category' type='checkbox' value='<%= title %>' checked='checked'><%= title %></label>");

      CategoryView.prototype.render = function() {
        _.each(this.collection.models, function(category) {
          var categoryTemplate;
          categoryTemplate = this.template(category.toJSON());
          return this.$el.append(categoryTemplate);
        }, this);
        return this.$el.append('<a href="#" class="toggle">Show/hide all</a>');
      };
    ...
    return Views.FilterView = (function(superClass) {
...
(function() {
  ...
  this.BackboneIndex.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    Entities.Extension = (function(superClass) {
    ...
    return Entities.ExtensionList = (function(superClass) {
      extend(ExtensionList, superClass);

      function ExtensionList() {
        return ExtensionList.__super__.constructor.apply(this, arguments);
      }
  ...
  this.BackboneIndex.module("Views", function(Views, App, Backbone, Marionette, $, _) {
    Views.ExtensionView = (function(superClass) {
      extend(ExtensionView, superClass);

      function ExtensionView() {
        return ExtensionView.__super__.constructor.apply(this, arguments);
      }
    ...
    return Views.ExtensionsView = (function(superClass) {
      extend(ExtensionsView, superClass);

      function ExtensionsView() {
        return ExtensionsView.__super__.constructor.apply(this, arguments);
      }
